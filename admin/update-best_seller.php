...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM tbl_bestseller WHERE id=$id";
    ...
    <div class="wrapper">
        ...
        <table class="tbl-30">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Bestseller" class="btn-primary"></input>
                </td>
            </tr>
        </table>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql3 = "UPDATE tbl_bestseller SET
                    food = '$title',
                    price = $price,
