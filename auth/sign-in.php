...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   if ($email && $password) {
      $sql = "SELECT * FROM tbl_user WHERE customer_email='$email'";
                  ...
                  <a href="../index.php">
                     <img src="../img/logo.png" class="img-fluid logo-img"  alt="logo">
                           ...
                           <form method="POST">
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="email" class="form-control form-control-sm" name="customer_email" id="email" aria-describedby="email" placeholder=" ">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
                              ...
                              <p class="mt-3 text-center">
                              Log into username? <a href="../auth/sign-in_username.php" class="text-underline">Click here to sign in.</a>
                              </p>
                           </form>
                        </div>
            </div>
